...
CRONJOBS = [
    ...
    ('31 22 * * mon,tue,wed,thu,fri', 'staffingapp.cron.generate_daily_submission_report_for_recruiter', ['India', True],
    {'delay': 4}, '>> /var/log/scheduled_job.log'),
    ('32 22 * * mon,tue,wed,thu,fri', 'staffingapp.cron.generate_daily_job_report_for_bdm', ['India', True],
     {'delay': 4}, '>> /var/log/scheduled_job.log'),
    ('33 22 * * mon,tue,wed,thu,fri', 'staffingapp.cron.generate_daily__recruiter_summary_report', ['India', True],
     {'delay': 4}, '>> /var/log/scheduled_job.log'),

    ('31 9 * * mon,tue,wed,thu,fri,sat', 'staffingapp.cron.sendmail_last_48hours_bdm_jobs', ['India', True],
     {'delay': 4}, '>> /var/log/scheduled_job.log'),
    #('30 18 * * mon,tue,wed,thu,fri,sat', 'staffingapp.cron.generate_bdm_daily_submission_report', ['India', True],
    # {'delay': 4}, '>> /var/log/scheduled_job.log'),
    ('30 17 * * wed,fri', 'staffingapp.cron.generate_send_weekly_recruiter_submission_follow_up', ['India', True],
     {'delay': 4}, '>> /var/log/scheduled_job.log'),
    ('31 17 * * mon,tue,wed,thu,fri', 'staffingapp.cron.send_daily_bdm_jobs_summary_report', ['India', True],
     {'delay': 4}, '>> /var/log/scheduled_job.log'),
    ...
    # {'delay': 4}, '>> /var/log/scheduled_job.log'),
    ('35 17 * * wed,fri', 'staffingapp.cron.generate_send_weekly_recruiter_submission_follow_up', ['US', True],
     {'delay': 4}, '>> /var/log/scheduled_job.log'),
    ('11 3 * * mon,tue,wed,thu,fri', 'staffingapp.cron.send_daily_bdm_jobs_summary_report', ['US', True],
     {'delay': 4}, '>> /var/log/scheduled_job.log'),
    ...
    ('31 6 * * sun', 'staffingapp.cron.sendmail_for_weekly_recruiter_submission', ['US', True], {'delay': 4},
     '>> /var/log/scheduled_job.log'),
    ('32 6 * * sun', 'staffingapp.cron.sendmail_for_weekly_bdm_jobs', ['US', True], {'delay': 4},
     '>> /var/log/scheduled_job.log'),
    ('33 6 * * sun', 'staffingapp.cron.send_weekly_bdm_jobs_summary_report', ['US', True], {'delay': 4},
     '>> /var/log/scheduled_job.log'),
    # Parse call data
    ('31 9 * * mon,tue,wed,thu,fri,sat', 'staffingapp.cron.parse_recruiter_calls_data_jobs', ['India', True],
     {'delay': 4}, '>> /var/log/scheduled_job.log'),
]
