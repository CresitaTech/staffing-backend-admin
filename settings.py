...
lib_path = 'D:/ATS-OSMS-BCK-python/staffing-app-back-end-development-latest/lib/libgobject-2.0-0.dll'
gobject_lib = ctypes.CDLL(lib_path)

# os.environ['PATH'] = 'D:/ATS-OSMS-BCK-python/staffing-app-back-end-development-latest/lib/libgobject-2.0-0:' + os.environ['PATH']
...
EMAIL_HOST_PASSWORD = 'ljuxqfqknweahlir'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            # 'libraries': {
            #     'custom_filters': 'staffing-app-back-end-development-latest.jobdescriptions.templatetags.custom_filters',
            # },
        },
    },
]
