...
from reports.views import RecruiterPerformanceSummaryCSV, RecruiterPerformanceSummaryTable, \
    ...
    JobSubmissionsByClientCSV, JobSubmissionsByClientGraph, TopFiveHighPriorityJobs, CandidateCSV, CandidateTable, \
    CandidateGraph, BdmActiveJobSummaryTable, \
...
urlpatterns = [
    ...
    path('recruiter_calls_performance_summary_csv/', RecruiterCallsPerformanceSummaryCSV.as_view(), name='recruiter_calls_performance_summary_csv'),
    path('recruiter_calls_performance_summary_table/', RecruiterCallsPerformanceSummaryTable.as_view(), name='recruiter_calls_performance_summary_table'),
    path('recruiter_calls_performance_summary_graph/', RecruiterCallsPerformanceSummaryGraph.as_view(), name='recruiter_calls_performance_summary_graph'),
    path('recruiter_calls_performance_summary_alldata/', RecruiterCallsPerformanceSummaryAllData.as_view(),
         name='recruiter_calls_performance_summary_alldata'),
    path('recruiter_calls_performance_summary_alldata_by_job_id/', RecruiterCallsPerformanceSummaryAllDataByJobId.as_view(),
         name='recruiter_calls_performance_summary_alldata_by_job_id'),
    path('recruiter_calls_performance_summary_alldata_by_job_id_csv/', RecruiterCallsPerformanceSummaryAllDataByJobIdCSV.as_view(),
         name='recruiter_calls_performance_summary_alldata_by_job_id_csv'),

    path('recruiter_calls_performance_summary_by_job_and_recruiter/', RecruiterCallsPerformanceSummaryByJobAndRecruiter.as_view(),
         name='recruiter_calls_performance_summary_by_job_and_recruiter'),
    path('recruiter_calls_performance_summary_by_job_and_recruiter_csv/', RecruiterCallsPerformanceSummaryByJobAndRecruiterCSV.as_view(),
         name='recruiter_calls_performance_summary_by_job_and_recruiter_csv'),

    path('candidate_csv/', CandidateCSV.as_view(), name='CandidateCSV'),
    path('candidate_table/', CandidateTable.as_view(), name='CandidateTable'),
    path('candidate_graph/', CandidateGraph.as_view(), name='CandidateGraph'),
    ...
    path('get_candidate_detail_by_job_id/', CandidateDetailsByJobId.as_view(), name='get_candidate_detail_by_job_id'),
    path('job_summary_table_by_title_alldata/', JobSummaryTableByIdAllData.as_view(), name='job_summary_table_by_title'),
    path('get_jobs_summary_by_datewise_breakdown/', JobSummaryTableByDatewiseBreakdown.as_view(), name='get_jobs_summary_by_datewise_breakdown'),
    ...
    path('get_top_five_high_priority_jobs/', TopFiveHighPriorityJobs.as_view(), name='Top Five High Priority Jobs List'),
    ...
    path('bdm_active_jobs_summary/', BdmActiveJobSummaryTable.as_view(), name='bdm_active_jobs_summary'),
    ...
    path('send_weekly_bdm_jobs_summary/', views.send_weekly_bdm_jobs_summary, name='Send BDM Weekend email'),
    path('send_daily_bdm_jobs_summary/', views.send_daily_bdm_jobs_summary, name='Send BDM Weekend email'),

    path('get_current_job_status/', views.get_current_job_status, name='get_current_job_status'),
