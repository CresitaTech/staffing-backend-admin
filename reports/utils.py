...
def formulaFields():
    aggregateData = "sum(case when s.stage_name = 'Candidate Added' then 1 else 0 end) as CandidateAdded, " \
                    ...
                    "sum(case when (s.stage_name = 'Submission' OR s.stage_name = 'Submission Reject' OR s.stage_name = 'Internal Interview' OR s.stage_name = 'Internal Interview Reject' OR s.stage_name = 'Candidate Review' OR s.stage_name = 'SendOut' OR s.stage_name = 'SendOut Reject' OR s.stage_name = 'Client Interview - First' OR s.stage_name = 'Interview Backout' OR s.stage_name = 'Interview Select' OR s.stage_name = 'Client Interview - Second' OR s.stage_name = 'Second Interview Reject' OR s.stage_name = 'Offered' OR s.stage_name = 'Offer Rejected' OR s.stage_name = 'Offer Backout' OR s.stage_name = 'Feedback Awaited' OR s.stage_name = 'Hold by BDM' OR s.stage_name = 'Hold by Client' OR s.stage_name = 'Placed' OR s.stage_name = 'Interview Reject') then 1 else 0 end) as Submission, " \
                    ...
                    "sum(case when (s.stage_name = 'SendOut' OR s.stage_name = 'SendOut Reject' OR s.stage_name = 'Client Interview - First' OR s.stage_name = 'Interview Backout' OR s.stage_name = 'Interview Reject' OR s.stage_name = 'Interview Select' OR s.stage_name = 'Client Interview - Second' OR s.stage_name = 'Second Interview Reject' OR s.stage_name = 'Offered' OR s.stage_name = 'Offer Rejected' OR s.stage_name = 'Offer Backout' OR s.stage_name = 'Feedback Awaited' OR s.stage_name = 'Hold by Client' OR s.stage_name = 'Placed' ) then 1 else 0 end) as 'SendOut'," \
                    "sum(case when s.stage_name = 'Sendout Reject' then 1 else 0 end) as SendoutReject ," \
                    "sum(case when (s.stage_name = 'Client Interview - First' OR s.stage_name = 'Interview Backout' OR s.stage_name = 'Interview Reject' OR s.stage_name = 'Interview Select' OR s.stage_name = 'Client Interview - Second' OR s.stage_name = 'Second Interview Reject' OR s.stage_name = 'Offered' OR s.stage_name = 'Offer Rejected' OR s.stage_name = 'Offer Backout' OR s.stage_name = 'Feedback Awaited' OR s.stage_name = 'Hold by Client' OR s.stage_name = 'Placed' ) then 1 else 0 end) as ClientInterview ," \
                    "sum(case when s.stage_name = 'Interview Reject' then 1 else 0 end) as 'RejectedByClient'," \
                    "sum(case when (s.stage_name = 'Offered' OR s.stage_name = 'Offer Rejected' OR s.stage_name = 'Offer Backout' OR s.stage_name = 'Placed') then 1 else 0 end) as Offered ," \
