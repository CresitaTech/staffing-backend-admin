...
EDUCATION = [
    'BE', 'B.E.', 'B.E', 'BS', 'B.S',
    'ME', 'M.E', 'M.E.', 'MS', 'M.S',
    'BTECH', 'B.TECH', 'M.TECH', 'MTECH', 'MTech', 'Master of Technology', 'Bachelor of Technology',
...
def extract_name(resume_text):
    ...
    matcher.add('NAME', [pattern, pattern1, pattern2, pattern3])
...
def extract_education(resume_text):
    ...
    education = []
    for key in edu.keys():
        year = re.search(re.compile(r'(((20|19|18|21|13)(\d{2})))'), edu[key])
        if year:
