...
import os
from staffingapp.tasks import Celery
...
app.conf.beat_schedule = {
    ...
    'generate_daily_submission_report_for_indian_recruiter': {
        ...
        'schedule': crontab(minute='30', hour='19', day_of_week='mon,tue,wed,thu,fri'),
    },
    ...
    'generate_daily_submission_report_for_us_recruiter': {
        ...
        # 'schedule': crontab(minute='*/1'),
        'schedule': crontab(minute='30', hour='06', day_of_week='tue,wed,thu,fri,sat'),
    },
    ...
    # weekly report for daily
    #'send_daily_recuiter_performance_report_for_indian_bdm': {
    #    'task': 'send_daily_recuiter_performance_report_for_indian_bdm',
    #    'schedule': crontab(minute='30', hour='19', day_of_week='mon,tue,wed,thu,fri'),
    #},
    #'send_daily_recuiter_performance_report_for_us_bdm': {
    #    'task': 'send_daily_recuiter_performance_report_for_us_bdm',
    #    'schedule': crontab(minute='30', hour='06', day_of_week='tue,wed,thu,fri,sat'),
    #},
