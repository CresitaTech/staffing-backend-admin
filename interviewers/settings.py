...
sentry_sdk.init(
    dsn="https://684924f784a946c49755c9e597bbf9dd@o4503998385225728.ingest.sentry.io/4503998400364544",
    integrations=[
        DjangoIntegration(),
    ],
...
CRONJOBS = [
    ...
    ('01 17 * * wed,fri', 'staffingapp.cron.generate_send_weekly_recruiter_submission_follow_up', ['India', True],
     {'delay': 4}, '>> /var/log/scheduled_job.log'),
    ('01 16 * * mon,tue,wed,thu,fri', 'staffingapp.cron.send_daily_bdm_jobs_summary_report', ['India', True],
     {'delay': 4}, '>> /var/log/scheduled_job.log'),
